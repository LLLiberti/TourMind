...
import static com.hmdp.constant.RedisConstant.BLOG_LIKED_KEY;
import static com.hmdp.constant.RedisConstant.FEED_KEY;
...
public class BlogServiceImpl extends ServiceImpl<BlogMapper, Blog> implements IBlogService {
    ...
    public Result queryBlogLikes(Long id) {
        ...
        // 2.解析出其中的用户id
        List<Long> ids = top5.stream().map(obj ->Long.valueOf(obj.toString())).collect(Collectors.toList());
